...
import com.housekeeper.activity.landlord.LandlordRelationActivity;
 ...
 */
public class TenantRelationActivity extends BaseActivity implements QRCodeView.ResultHandler, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.activity_tenant_relation);
    ...
    private void requestRelation(String code) {
        ...
        JSONRequest request = new JSONRequest(this, RequestEnum.LEASE_USERJOIN, map, new Response.Listener<String>() {
            ...
            public void onResponse(String jsonObject) {
                try {
                    ...
                    if (dto.getStatus() == AppResponseStatus.SUCCESS) {
                        ...
                        Toast.makeText(TenantRelationActivity.this, "关联成功", Toast.LENGTH_SHORT).show();

                    } else {
                        Toast.makeText(TenantRelationActivity.this, dto.getMsg(), Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
