...
import com.housekeeper.activity.view.ItemDescOfTransferView;
 ...
 * 
 */
public class VoteOfTransferActivity extends BaseActivity implements OnClickListener {
	...
	private ItemDescOfTransferView itemDescOfTransferView = null; // 项目说明
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_vote_transfer);
	...
	private void initView() {
		...
		contentLayout.addView(itemDescOfTransferView, new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
			...
			public void onResponse(String jsonObject) {
				...
				objectMapper.configure(DeserializationConfig.Feature.FAIL_ON_UNKNOWN_PROPERTIES,false);
					...
					if (dto.getStatus() == AppResponseStatus.SUCCESS) {
						...
						Toast.makeText(VoteOfTransferActivity.this, dto.getMsg(), Toast.LENGTH_SHORT).show();
					}
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	private void refreshView() {
		itemDescOfTransferView.setValue(infoDto);
	...
	public void onClick(View v) {
		...
		case R.id.claimsTextView:
			...
			itemDescOfTransferView.setVisibility(View.GONE);
