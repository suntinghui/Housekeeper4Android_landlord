...
public class HighlightView {
	...
	private void init() {
		...
		// mResizeDrawableWidth = resources.getDrawable(R.drawable.gl_camera_crop_width);
		// mResizeDrawableHeight = resources.getDrawable(R.drawable.gl_camera_crop_height);
